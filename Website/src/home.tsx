      ...
      <div className="container mx-auto px-8 pt-40 pb-32">
        ...
        <div className="relative mb-32">
          <div className="max-w-3xl flex-row align-center">
            ...
            >
              {" "}
              Level Up Your Social Media Game with one click !{" "}
            </motion.p>
            <Link to={"/Social_Abstractions/chat"}>
              <motion.button
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
        ...
        >
          ...
          <div className="relative">
            <h2 className="text-4xl font-script text-white mb-8">
              See it in Action
            </h2>
          ...
          {[
            {
              ...
              description:
                "Our advanced machine learning algorithms analyze your conversations in real-time, providing deep insights into communication patterns, sentiment trends, and engagement metrics.",
              align: "right",
            },
            {
              icon: Star,
              ...
              description:
                "Get immediate actionable insights from your chat data, helping you make informed decisions and improve your communication strategy instantly.",
              align: "left",
            },
            {
              icon: TrendingUp,
              ...
              description:
                "Stay ahead of the curve with our powerful trend detection system that identifies emerging patterns and helps you adapt your approach proactively.",
              align: "right",
            },
          ].map((feature, index) => (
            <motion.div
            ...
            >
              <div
                className={`flex-1 ${
                  feature.align === "left" ? "text-left" : "text-right"
                }`}
              >
                <feature.icon className="w-16 h-16 text-purple-300 mb-6 inline-block" />
                <h3 className="text-4xl font-script text-white mb-6">
                  {feature.title}
                </h3>
